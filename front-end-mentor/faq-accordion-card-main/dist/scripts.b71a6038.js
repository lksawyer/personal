...
$(document).ready(function () {
  console.log("scripts loaded"); // Get the height of all e.currentTarget.children[2]
  // Store these values
  ...
  $(".c-fold").click(function (e) {
    ...
    console.log("e :", e);
    var active = is_active(e); // Determine whether or not .is-active should be removed or added
...
function remove_active(e) {
  debugger; // Remove .is-active from selected .c-fold children
